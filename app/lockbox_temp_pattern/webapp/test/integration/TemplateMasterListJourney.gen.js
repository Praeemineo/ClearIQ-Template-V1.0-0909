...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("TemplateMasterListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheTemplateMasterListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheTemplateMasterListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheTemplateMasterListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheTemplateMasterListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheTemplateMasterListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheTemplateMasterListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheTemplateMasterListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheTemplateMasterObjectPageGenerated.iSeeThisPage();
        });
